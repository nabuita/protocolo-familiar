...
const insuranceCoverageProfiles = {
    ...
    'Responsabilidad civil extracontractual': ['Responsabilidad civil extracontractual', 'RC predios labores y operaciones', 'Danos materiales a terceros', 'Lesiones o muerte de terceros', 'Perjuicios patrimoniales consecuenciales', 'Gastos medicos', 'Gastos de defensa', 'Pagos suplementarios', 'Responsabilidad civil patronal', 'Bienes bajo cuidado tenencia y control', 'Polucion y contaminacion', 'Responsabilidad cruzada', 'Uso de vehiculos propios y no propios', 'Uso de parqueaderos', 'Nuevos predios y operaciones', 'Asistencia juridica'],
...
const insuranceCoverageAcademy = {
    ...
    'Danos materiales a terceros': { kind: 'Responsabilidad', assets: ['Terceros afectados'], basis: 'Limite por evento y vigencia; no sale de inventario de bienes.', review: 'Verificar predios, labores, operaciones, actividad real y deducible.' },
    'Lesiones o muerte de terceros': { kind: 'Responsabilidad', assets: ['Personas terceras'], basis: 'Limite por evento y vigencia segun aforo, visitantes, trabajadores indirectos y actividad.', review: 'Confirmar alcance de lesiones, muerte, gastos medicos y exclusiones.' },
    'Perjuicios patrimoniales consecuenciales': { kind: 'Responsabilidad', assets: ['Patrimonio de terceros'], basis: 'Limite o sublimite segun contrato, actividad y apetito de riesgo.', review: 'Debe quedar claro si opera dentro del limite basico o en adicion.' },
    'Pagos suplementarios': { kind: 'Responsabilidad', assets: ['Defensa, cauciones y gastos autorizados'], basis: 'Sublimite por evento/vigencia dentro del limite basico.', review: 'Confirmar autorizaciones previas, costas, intereses y gastos cubiertos.' },
    'Bienes bajo cuidado tenencia y control': { kind: 'Responsabilidad', assets: ['Bienes de terceros bajo custodia'], basis: 'Sublimite por evento/vigencia.', review: 'Revisar si levanta exclusiones y bajo que contratos o tenencia.' },
    'Polucion y contaminacion': { kind: 'Responsabilidad', assets: ['Terceros afectados por contaminacion accidental'], basis: 'Sublimite por evento/vigencia.', review: 'Debe ser accidental, subita e imprevista; no asumir contaminacion gradual.' },
    'Uso de vehiculos propios y no propios': { kind: 'Responsabilidad', assets: ['Vehiculos usados en la operacion'], basis: 'Sublimite en exceso de SOAT/RCE automoviles.', review: 'Verificar exclusiones por servicio publico, empleados, carga y uso.' },
    'Uso de parqueaderos': { kind: 'Responsabilidad', assets: ['Vehiculos de terceros en parqueadero'], basis: 'Sublimite por vehiculo, evento o vigencia.', review: 'Exige control de ingreso/salida, vigilancia y condiciones de custodia.' },
    'Nuevos predios y operaciones': { kind: 'Responsabilidad', assets: ['Predios u operaciones incorporadas durante la vigencia'], basis: 'Sublimite automatico sujeto a aviso y condiciones.', review: 'Registrar fecha, predio, actividad y aviso a aseguradora.' },
...
const insuranceCoveragePolicyTermDefaults = {
    'responsabilidad civil extracontractual': {
        ...
        source: 'Poliza 440-97-994000000156-0: RCE limite contratado $500.000.000 por evento / $500.000.000 por vigencia.',
    },
    ...
    'gastos de defensa': {
        limite_evento: '50000000',
        limite_vigencia: '75000000',
        sublimite: '10% por evento y 15% por vigencia, dentro del limite basico.',
        deducible_porcentaje: '15%',
        deducible_minimo: '3 SMMLV',
        deducible_texto: 'Amparo adicional sublimitado: 15% del valor de la perdida, minimo 3 SMMLV.',
        source: 'Poliza 440-97-994000000156-0: condiciones particulares RCE, gastos/costos de defensa.',
    },
    'costos y gastos de defensa': {
        ...
        deducible_minimo: '3 SMMLV',
        deducible_texto: 'Amparo adicional sublimitado: 15% del valor de la perdida, minimo 3 SMMLV.',
        source: 'Poliza 440-97-994000000156-0: condiciones particulares RCE, costos y gastos de defensa.',
    },
    'gastos medicos': {
        limite_evento: '50000000',
        limite_vigencia: '75000000',
        ...
        deducible_minimo: '3 SMMLV',
        deducible_texto: 'Amparo adicional sublimitado: 15% del valor de la perdida, minimo 3 SMMLV.',
        source: 'Poliza 440-97-994000000156-0: condiciones particulares RCE, gastos medicos.',
    },
    'pagos suplementarios': {
        limite_evento: '75000000',
        limite_vigencia: '100000000',
        sublimite: '15% por evento y 20% por vigencia, dentro del limite basico.',
        deducible_porcentaje: '15%',
        deducible_minimo: '3 SMMLV',
        deducible_texto: 'Amparo adicional sublimitado: 15% del valor de la perdida, minimo 3 SMMLV.',
        source: 'Poliza 440-97-994000000156-0: condiciones particulares RCE, pagos suplementarios.',
    },
    'responsabilidad civil patronal': {
        ...
        deducible_porcentaje: '15%',
        deducible_minimo: '3 SMMLV',
        deducible_texto: 'Amparo patronal sublimitado: 15% del valor de la perdida, minimo 3 SMMLV.',
        source: 'Poliza 440-97-994000000156-0: condiciones particulares RCE, RC patronal.',
    },
    'responsabilidad cruzada': {
        ...
        deducible_porcentaje: '15%',
        deducible_minimo: '3 SMMLV',
        deducible_texto: 'RC cruzada sublimitada: 15% del valor de la perdida, minimo 3 SMMLV.',
        source: 'Poliza 440-97-994000000156-0: condiciones particulares RCE, responsabilidad civil cruzada.',
    },
    'bienes bajo cuidado tenencia y control': {
        ...
        deducible_minimo: '3 SMMLV',
        deducible_texto: 'Amparo adicional sublimitado: 15% del valor de la perdida, minimo 3 SMMLV.',
        source: 'Poliza 440-97-994000000156-0: condiciones particulares RCE, bienes bajo cuidado, tenencia y control.',
    },
    'polucion y contaminacion': {
        ...
        deducible_porcentaje: '15%',
        deducible_minimo: '3 SMMLV',
        deducible_texto: 'Solo accidental, subito e imprevisto: 15% del valor de la perdida, minimo 3 SMMLV.',
        source: 'Poliza 440-97-994000000156-0: condiciones particulares RCE, polucion y contaminacion.',
    },
    'uso de vehiculos propios y no propios': {
        limite_evento: '75000000',
        limite_vigencia: '100000000',
        sublimite: '15% por evento y 20% por vigencia, dentro del limite basico.',
        deducible_porcentaje: '15%',
        deducible_minimo: '3 SMMLV',
        deducible_texto: 'Opera en exceso de SOAT/RCE autos: 15% del valor de la perdida, minimo 3 SMMLV.',
        source: 'Poliza 440-97-994000000156-0: condiciones particulares RCE, uso de vehiculos propios y no propios.',
    },
    'uso de parqueaderos': {
        limite_evento: '75000000',
        limite_vigencia: '100000000',
        ...
        deducible_porcentaje: '15%',
        deducible_minimo: '3 SMMLV',
        deducible_texto: 'Exige parqueadero cerrado, vigilado y registro: 15% del valor de la perdida, minimo 3 SMMLV.',
        source: 'Poliza 440-97-994000000156-0: condiciones particulares RCE, uso de parqueaderos.',
    },
    'nuevos predios y operaciones': {
        limite_evento: '75000000',
        limite_vigencia: '100000000',
        sublimite: '15% por evento y 20% por vigencia, dentro del limite basico.',
        deducible_porcentaje: '15%',
        deducible_minimo: '3 SMMLV',
        deducible_texto: 'Cobertura automatica sublimitada: 15% del valor de la perdida, minimo 3 SMMLV.',
        source: 'Poliza 440-97-994000000156-0: condiciones particulares RCE, nuevos predios y operaciones.',
    },
    incendio: {
        valor_actual: '1523000000',
        limite_evento: '1523000000',
        limite_vigencia: '1523000000',
        indice_variable_actual: '5% lineal durante la vigencia',
        deducible_porcentaje: '10%',
        deducible_minimo: '1 SMMLV',
        deducible_texto: 'Amparo basico: 10% del valor de la perdida, minimo 1 SMMLV.',
        source: 'Poliza 440-97-994000000156-0: edificio $1.523.000.000, indice variable 5%. No asegurar terreno.',
    },
    'incendio y coberturas aliadas': {
        valor_actual: '1523000000',
        limite_evento: '1523000000',
        limite_vigencia: '1523000000',
        indice_variable_actual: '5% lineal durante la vigencia',
        deducible_porcentaje: '10%',
        deducible_minimo: '1 SMMLV',
        deducible_texto: 'Incendio/rayo/calor/humo y aliadas: 10% del valor de la perdida, minimo 1 SMMLV.',
        source: 'Poliza 440-97-994000000156-0: condiciones particulares, paginas 1-2.',
    },
    rayo: {
        deducible_porcentaje: '10%',
        deducible_minimo: '1 SMMLV',
    ...
    anegacion: {
        deducible_porcentaje: '10%',
        deducible_minimo: '2 SMMLV',
        deducible_texto: 'ALERTA: caratula agrupa demas eventos con 2% del valor asegurable minimo 3 SMMLV, pero texto particular fija 10% de la perdida minimo 2 SMMLV. Solicitar aclaracion/endoso.',
        source: 'Poliza 440-97-994000000156-0: conflicto caratula vs condiciones particulares pagina 8.',
    },
    inundacion: {
        deducible_porcentaje: '10%',
        deducible_minimo: '2 SMMLV',
    ...
    'actos mal intencionados de terceros': {
        deducible_porcentaje: '10%',
        deducible_minimo: '1 SMMLV',
        deducible_texto: 'AMIT/terrorismo: 10% del valor de la perdida, minimo 1 SMMLV; no admite restablecimiento automatico de suma asegurada.',
        source: 'Poliza 440-97-994000000156-0: condiciones particulares, AMIT/terrorismo.',
    },
    terrorismo: {
        deducible_porcentaje: '10%',
        deducible_minimo: '1 SMMLV',
    ...
    terremoto: {
        ...
        limite_vigencia: '1523000000',
        indice_variable_actual: '5% lineal durante la vigencia',
        deducible_porcentaje: '2%',
        deducible_minimo: '3 SMMLV',
        deducible_texto: '2% del valor asegurable del articulo afectado, minimo 3 SMMLV. Eventos dentro de 72 horas consecutivas cuentan como un solo siniestro.',
        source: 'Poliza 440-97-994000000156-0: terremoto, temblor, erupcion volcanica y eventos de la naturaleza.',
    },
    ...
    vidrios: {
        valor_actual: '200000000',
        limite_evento: '200000000',
        limite_vigencia: '200000000',
        indice_variable_actual: '5% lineal durante la vigencia',
        deducible_porcentaje: '10%',
        deducible_minimo: '1 SMMLV',
        deducible_texto: '10% del valor de la perdida, minimo 1 SMMLV. La suma debe salir de relacion de vidrios valorizada.',
        source: 'Poliza 440-97-994000000156-0: vidrios $200.000.000, indice variable 5%.',
    },
    'rotura de maquinaria': {
        valor_actual: '28900000',
        limite_evento: '28900000',
        limite_vigencia: '28900000',
        indice_variable_actual: '5% lineal durante la vigencia',
        deducible_porcentaje: '10%',
        deducible_minimo: '1 SMMLV',
        deducible_texto: 'Confirmar deducible por dano interno/rotura y aplicar demerito particular si corresponde.',
        source: 'Poliza 440-97-994000000156-0: maquinaria y equipo $28.900.000, indice variable 5%.',
        demerito: 'Maquinaria/equipo: 0-5 anos 0%; >5 y <8: 20%; >8 y <10: 40%; >10: 60%.',
    },
    'dano interno': {
        deducible_porcentaje: '10%',
        deducible_minimo: '1,5 SMMLV',
        deducible_texto: 'ALERTA CRITICA: caratula indica 10% minimo 1,5 SMMLV; texto posterior indica 15% minimo 2 SMMLV. Solicitar aclaracion o endoso.',
        source: 'Poliza 440-97-994000000156-0: contradiccion dano interno, condiciones particulares paginas 2 y 8.',
        demerito: 'Maquinaria/equipo: 0-5 anos 0%; >5 y <8: 20%; >8 y <10: 40%; >10: 60%. Equipos electricos/electronicos: 0-3 anos 0%; >3 y <4: 20%; >4 y <5: 30%; >5 y <6: 40%; >6: 50%.',
    },
    'equipo electronico / corriente debil': {
        ...
        demerito: 'Equipos electricos/electronicos: 0-3 anos 0%; >3 y <4: 20%; >4 y <5: 30%; >5 y <6: 40%; >6: 50%.',
    },
    'perdida de ingresos automatica': {
        sublimite: '5% adicional del valor indemnizado de los bienes afectados, maximo 3 meses; excluye dineros.',
        deducible_texto: 'Opera automaticamente solo si no se contrato lucro cesante forma inglesa.',
        source: 'Poliza 440-97-994000000156-0: perdida de ingresos automatica, condiciones particulares pagina 3.',
    },
    'perdida de arrendamiento por siniestro': {
        contratado_actual: 'No',
        sublimite: '1% mensual del valor asegurado del inmueble, maximo COP 5.000.000 mensuales y hasta 6 meses. Exige suma asegurada/prima especifica.',
        deducible_texto: 'Disponible, pero no activa en la caratula de esta poliza. No tratar como contratada.',
        source: 'Condiciones generales SOLIPYME 2024 art. 2.6; no aparece en caratula de poliza 440-97-994000000156-0.',
    },
};
...
const applyInsurancePolicyTerms = (row = {}) => {
    ...
    return {
        ...row,
        contratado_actual: row.contratado_actual || terms.contratado_actual || '',
        valor_actual: row.valor_actual || terms.valor_actual || '',
        indice_variable_actual: row.indice_variable_actual || terms.indice_variable_actual || '',
...
const insurancePolicyPdfFieldMatrix = [
    {
        ...
        fuente: 'Caratula: AMPARO / OBJETO / SUMA ASEGURADA / % INVAR / SUBLIMITE / DEDUCIBLES. En esta poliza: edificio $1.523.000.000, vidrios $200.000.000 y maquinaria/equipo $28.900.000.',
        alerta: 'No incluir terreno. Separar construccion, vidrios, equipos y contenidos para evitar infra o supraseguro. Indice variable 5% lineal durante la vigencia.',
    },
    {
        ...
        alerta: 'En esta poliza figura 10% de la perdida minimo 1 SMMLV y no admite restablecimiento automatico de suma asegurada; validar si la nueva oferta conserva esa condicion.',
    },
    {
        ...
        alerta: 'Usar valor de reposicion sin terreno. En esta poliza terremoto indica 2% del valor asegurable minimo 3 SMMLV. Hay conflicto para otros eventos naturales: caratula 2% minimo 3 SMMLV vs texto particular 10% minimo 2 SMMLV.',
    },
    {
        ...
        alerta: 'La suma debe salir de area/tipo de vidrio por valor de reposicion e instalacion, no de una cifra global. En esta poliza: $200.000.000 con indice variable 5%.',
    },
    {
        ...
        alerta: 'No sale de inventario de bienes. En esta poliza el limite combinado es $500.000.000 evento / $500.000.000 vigencia; los amparos adicionales consumen o se sublimitian dentro de ese basico.',
    },
    {
        ...
        alerta: 'En esta poliza gastos medicos/defensa figuran 10% evento y 15% vigencia; pagos suplementarios, patronal, bienes bajo cuidado, contaminacion, RC cruzada, vehiculos, parqueaderos y nuevos predios figuran 15% evento y 20% vigencia.',
    },
    {
    ...
    },
    {
        ...
        alerta: 'No aceptar suma global sin relacion. Alerta critica: dano interno tiene contradiccion, caratula 10% minimo 1,5 SMMLV vs texto particular 15% minimo 2 SMMLV. Solicitar aclaracion/endoso.',
    },
    {
    ...
    },
    {
        ...
        alerta: 'Disponible en clausulado, pero NO activa en esta caratula. Regla de referencia: 1% mensual del valor asegurado del inmueble, maximo $5.000.000 mensuales y hasta 6 meses, con prima/suma especifica.',
    },
];
...
const insuranceCurrentPolicyOnlyTableHtml = (rows = []) => rows.length ? `
    <div class="asset-insurance-comparison-table asset-insurance-current-only-table" role="table" aria-label="Poliza actual por cobertura">
        ...
        ${rows.map((row) => {
            ...
            const valorActual = row.valor_actual || terms.valor_actual || '';
            const indiceActual = row.indice_variable_actual || terms.indice_variable_actual || '';
            ...
            <div class="asset-insurance-comparison-row" role="row">
                ...
                <label>
                    <span>Valor actual</span>
                    <input data-money-format inputmode="decimal" data-insurance-request-field="valor_actual" data-product="${assetEscape(row.ramo || '')}" data-coverage="${assetEscape(row.cobertura || '')}" value="${assetEscape(assetMoneyPlain(valorActual) || valorActual)}" placeholder="$0">
                </label>
                <label>
                    <span>Limites y sublimite</span>
                ...
                <label>
                    <span>Indice / tasa</span>
                    <input data-insurance-request-field="indice_variable_actual" data-product="${assetEscape(row.ramo || '')}" data-coverage="${assetEscape(row.cobertura || '')}" value="${assetEscape(indiceActual)}" placeholder="IPC, fijo, pactado">
