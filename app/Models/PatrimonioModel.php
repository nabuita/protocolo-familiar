    ...
    private function seguroPolizas(array $rows): array
    {
        ...
        foreach ($rows as $row) {
            ...
            $item = [
                ...
                'contacto_nombre' => $this->optional($row['contacto_nombre'] ?? null),
                'contacto_correo' => $this->optional($row['contacto_correo'] ?? null),
                'contacto_celular' => $this->optional($row['contacto_celular'] ?? null),
    ...
    private function seguroCoberturas(array $rows): array
    {
        ...
        foreach ($rows as $row) {
            ...
            $item = [
                ...
                'contratado_actual' => $this->optional($row['contratado_actual'] ?? null),
                'valor_actual' => $this->money($row['valor_actual'] ?? null),
                'limite_evento_actual' => $this->optional($row['limite_evento_actual'] ?? null),
                'sublimite_actual' => $this->optional($row['sublimite_actual'] ?? null),
                'deducible_actual' => $this->optional($row['deducible_actual'] ?? null),
                'indice_variable_actual' => $this->optional($row['indice_variable_actual'] ?? null),
                'tasa_actual' => $this->optional($row['tasa_actual'] ?? null),
                'prima_actual' => $this->money($row['prima_actual'] ?? null),
                'observaciones_actuales' => $this->optional($row['observaciones_actuales'] ?? null),
                'renovacion_solicitada' => $this->optional($row['renovacion_solicitada'] ?? null),
                'valor_asegurado' => $this->money($row['valor_asegurado'] ?? null),
                'limite_evento' => $this->optional($row['limite_evento'] ?? null),
                'porcentaje_invar' => $this->decimal($row['porcentaje_invar'] ?? null),
                'indice_variable' => $this->optional($row['indice_variable'] ?? null),
